          ...
          <div className="relative">
            <div className="glass-panel rounded-3xl overflow-hidden shadow-2xl shadow-slate-200/80">
              <div className="relative w-full aspect-square">
                <Image src="/banner.png" alt="TAI Programs" fill className="object-cover" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-600">
                ...
                <li><a href="/staff" className="hover:text-slate-900 flex items-center gap-1.5"><i className="ph ph-users"></i> {t.footerStaff}</a></li>
              </ul>
            </div>
          </div>
