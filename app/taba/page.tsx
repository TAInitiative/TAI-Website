...
const translations = {
  en: {
    ...
    comingSoonBadge: "Coming Soon", comingSoonBanner: "TABA hasn't launched yet — everything below describes what we're building. Join our Discord to be notified when it opens.",
  },
  zh: {
    ...
    comingSoonBadge: "即將推出", comingSoonBanner: "TABA 尚未正式啟動——以下內容說明我們正在籌備的計畫。加入 Discord，上線時我們將第一時間通知您。",
  },
};
