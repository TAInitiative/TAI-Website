          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-600">
                ...
                <li><a href="/taba" className="hover:text-slate-900 font-medium text-taiwan-red flex items-center gap-1.5"><i className="ph ph-rocket-launch"></i> TABA — Business Accelerator</a></li>
                <li><a href="/talec" className="hover:text-slate-900 flex items-center gap-1.5"><i className="ph ph-book-open"></i> TALEC — Language & Culture</a></li>
              </ul>
            </div>
            <div>
