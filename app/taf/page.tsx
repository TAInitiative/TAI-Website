          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-600">
                <li><a href="/taf" className="hover:text-slate-900 font-medium text-taiwan-blue flex items-center gap-1.5"><i className="ph ph-cross"></i> TAF — Truth Alliance Fellowship</a></li>
